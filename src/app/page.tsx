...
const Welcome = () => {
  ...
  return (
    ...
    >
      ...
      <div className='fixed bottom-[3rem] flex w-full flex-col items-center'>
        {welcomeState === WELCOME_STATE.WELCOME && (
          <div
            ref={buttonRef}
            style={{
          ...
          >
            <div className='group relative transition-all duration-300 active:scale-95'>
              ...
              <button className='relative mx-[14px] py-[4px] text-[48px] font-[400] text-[#928979] transition-all group-hover:text-[#F4E4CA]'>
                Click to enter
              </button>
            </div>
          </div>
