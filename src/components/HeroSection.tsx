    ...
    >
      <div className='relative z-10 flex h-full w-full flex-col items-center justify-end'>
        <Image
          ...
          width={492}
          height={700}
          className='absolute right-0 top-0 min-h-[700px]'
        />
        {pageState === PAGE_STATE.HERO && (
          <>
            <div className='relative mb-[1.5rem]'>
              <div className='mb-[18px] flex items-center justify-between px-[47px]'>
              ...
              <h1
                ...
                className='px-[32px] text-[58px] font-[400] uppercase leading-[1.3] text-[#F4E4CA]'
              >
                &nbsp;
